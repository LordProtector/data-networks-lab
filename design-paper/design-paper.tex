...
\ifthenelse{\boolean{m2}}{% text for milestone 2
  ...
  \fixme{More or other analysis wanted?}
  ...
  %With our implementation we reach a throughput from Homburg to Saarbrücken of 9.1 kB/s and 116.8 kB/s the other way around.
